...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    handleResize(); // Inicializa screenSize al montar el componente
  ...
  useEffect(() => {
    if (screenSize <= 900) {
      setActiveMenu(false); // Ocultar el menú en pantallas pequeñas
    } else {
      setActiveMenu(true); // Mostrar el menú en pantallas grandes
    }
  }, [screenSize]); // Dependencia agregada, solo se ejecutará cuando screenSize cambie
